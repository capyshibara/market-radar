package vn.techcomlife.marketradar.seed;
...
import vn.techcomlife.marketradar.domain.EvidenceFact.FactType;
...
import vn.techcomlife.marketradar.domain.Department;
...
import vn.techcomlife.marketradar.repo.RoutingRuleRepository;
...
public class SeedData implements CommandLineRunner {
    ...
    private void seedBatch6aSources() {
        ...
        sources.save(new Source("BIDV_METLIFE", "BIDV MetLife",
                ...
                Source.SourceType.HTML, 2, "vi"));
        // Added 2026-07-05, confirmed live (200 text/html). Batch 6b (same day): pointed at the real
        // news listing page (root was homepage only) — see parseMapLife.
        sources.save(new Source("MAP_LIFE", "Mirae Asset Prévoir (MAP Life)",
        ...
        sources.save(new Source("CATHAY_VN", "Cathay Life Việt Nam",
                ...
                Source.SourceType.HTML, 2, "vi"));
        sources.save(new Source("SUNLIFE_VN", "Sun Life Việt Nam",
        ...
        sources.save(new Source("SHINHAN_VN", "Shinhan Life Việt Nam",
                ...
                Source.SourceType.HTML, 2, "vi"));
        // ⚠️ assumption: registry lists lang "en/vi" (bilingual host) — single-lang field, picked "vi"
        // Track 2 2026-07-05: GET 404 at this exact path, URL stale/wrong — needs rediscovery. NOT fixed.
        sources.save(new Source("CHUBB_VN", "Chubb Life Việt Nam",
                "https://www.chubb.com/vn-en/chubb-life-insurance.html", "www.chubb.com",
                Source.SourceType.HTML, 2, "vi"));
        // Track 2 2026-07-05: 301 → http://dai-ichi-life.com.vn/ (downgrades to http, non-www) —
        // breaks https-only AND host whitelist even if redirect were followed. NOT fixed — needs a real URL.
        sources.save(new Source("DAIICHI_VN", "Dai-ichi Life Việt Nam",
                "https://www.dai-ichi-life.com.vn/", "www.dai-ichi-life.com.vn",
                Source.SourceType.HTML, 2, "vi"));
        ...
        sources.save(new Source("CHINALIFE_HK", "China Life (HK/overseas)",
                "https://www.chinalife.com.hk/en/news/", "www.chinalife.com.hk",
        ...
        // Track 2 fix 2026-07-05: 301 → same URL + trailing slash (same host).
        sources.save(new Source("PRU_HK", "Prudential HK",
                "https://www.prudential.com.hk/en/whoweare/media/", "www.prudential.com.hk",
                Source.SourceType.HTML, 2, "en"));

        // Taiwan
        // Track 2 2026-07-05: DNS NXDOMAIN, news.fubon.com doesn't resolve — domain wrong. NOT fixed.
        sources.save(new Source("FUBON_TW", "Fubon Life",
                "https://news.fubon.com/", "news.fubon.com",
                Source.SourceType.HTML, 2, "zh"));
        // Track 2 2026-07-05: serves an IBM/Tivoli WebSEAL auth-gateway error page, not real content —
        // URL behind an auth gate or misconfigured reverse proxy. NOT fixed.
        sources.save(new Source("CATHAY_TW", "Cathay Life (Taiwan)",
        ...
        sources.save(new Source("FSC_KR", "Financial Services Commission (Korea)",
                ...
                Source.SourceType.HTML, 1, "en"));
        // Track 2 2026-07-05: 302 → https://www.fss.or.kr/eng/main/main.do?menuNo=400000 — HOST CHANGES
        // (english.fss.or.kr → www.fss.or.kr), so allowedHost whitelist would also need updating.
        // NOT fixed — needs a real URL/host decision, not a one-line patch.
        sources.save(new Source("FSS_KR", "Financial Supervisory Service (Korea)",
                "https://english.fss.or.kr/", "english.fss.or.kr",
                Source.SourceType.HTML, 1, "en"));
        ...
        sources.save(new Source("TOKIO_MARINE", "Tokio Marine Holdings",
                "https://www.tokiomarinehd.com/en/news/", "www.tokiomarinehd.com",
                Source.SourceType.HTML, 2, "en"));
        sources.save(new Source("MSAD", "MS&AD Insurance Group",
                "https://www.ms-ad-hd.com/en/news/", "www.ms-ad-hd.com",
                Source.SourceType.HTML, 2, "en"));
        // Track 2 2026-07-05: GET 404 at this exact path — URL stale/wrong, needs rediscovery. NOT fixed.
        sources.save(new Source("NIPPON_LIFE", "Nippon Life",
                "https://www.nissay.co.jp/english/newsrelease.html", "www.nissay.co.jp",
                Source.SourceType.HTML, 2, "en"));
        ...
        sources.save(new Source("MAS_SG", "Monetary Authority of Singapore",
                ...
                Source.SourceType.HTML, 1, "en"));
        // Track 2 2026-07-05: 302 redirects straight to the site's own 404 error page — URL dead. NOT fixed.
        sources.save(new Source("GREAT_EASTERN", "Great Eastern",
                "https://www.greateasternlife.com/sg/en/about-us/newsroom.html",
        ...
        sources.save(new Source("AIA_SG", "AIA Singapore",
                "https://www.aia.com.sg/en/about-aia/press-releases.html", "www.aia.com.sg",
                Source.SourceType.HTML, 2, "en"));

        // ASEAN (other)
        sources.save(new Source("OJK_ID", "OJK (Indonesia)",
                "https://www.ojk.go.id/", "www.ojk.go.id",
                Source.SourceType.HTML, 1, "id"));
        sources.save(new Source("BNM_MY", "Bank Negara Malaysia",
                "https://www.bnm.gov.my/", "www.bnm.gov.my",
                Source.SourceType.HTML, 1, "en"));
        sources.save(new Source("IC_PH", "Insurance Commission (Philippines)",
        ...
        sources.save(new Source("PRULIFE_PH", "Pru Life UK (Philippines)",
                "https://www.prulifeuk.com.ph/media-centre/", "www.prulifeuk.com.ph",
                Source.SourceType.HTML, 2, "en"));
        sources.save(new Source("PHILAM_PH", "AIA Philippines (Philam)",
        ...
        sources.save(new Source("SWISSRE_INST", "Swiss Re Institute (Sigma)",
                "https://www.swissre.com/institute.html", "www.swissre.com",
                Source.SourceType.HTML, 2, "en"));
        ...
        sources.save(new Source("LIMRA", "LIMRA",
                ...
                Source.SourceType.HTML, 2, "en"));
        sources.save(new Source("MCKINSEY_INS", "McKinsey (Insurance)",
